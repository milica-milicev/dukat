...
<div class="tiles">
	<div class="container">
		<h2 class="tiles__title section-title">Najpopularniji proizvodi</h2>
		<div class="tiles__row">
			<div class="tiles__item">
				<img class="tiles__item-img" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/_demo/product-1.jpg" alt="">
			...
			<div class="tiles__item">
				<img class="tiles__item-img" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/_demo/product-3.jpg" alt="">
				<div class="tiles__item-info">
			...
			<div class="tiles__item">
				<img class="tiles__item-img" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/_demo/product-4.jpg" alt="">
				<div class="tiles__item-info">
